...
/// Feeds [count] full frames of [frequency] and returns the last reading.
///
  ...
  for (var i = 0; i < count; i++) {
    last = pipeline.feed(
      sinePcm(
        ...
        // Keep the sine continuous across frames rather than restarting
        // each one at phase zero, which would put a discontinuity at every
        // frame boundary the detector could latch onto.
        phaseOffsetSamples: i * 4096,
      ),
    );
  }
  return last;
