...
android {
    namespace = "io.kettner.semitone_web"
    ...
    buildTypes {
        release {
            ...
            // configured, so `flutter run --release` and CI builds without
            // the ANDROID_KEYSTORE_* secrets keep working unsigned-for-
            // distribution (fine for sideloaded GitHub-release APKs, not
            // for the Play Store).
